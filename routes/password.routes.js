...
//const { forgetPassword, resetPassword } = require("../middlewares/forgetPassword.controller.js");
 ...
 router.post("/forget-password", async (req,res,next)=>{
    try {
        ...
        const mailOptions = {
          ...
          to: req.body.email,
          subject: "Reiniciar contraseña de NUTROPIA",
...
// router.post("/reset-password/:token", resetPassword);//espera la nueva contraseña
